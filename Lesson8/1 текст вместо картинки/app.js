...
function showMoreText(card) {
    ...
    let textDiv = 'Lorem ipsum, dolor sit amet consectetur adipisicing elit. Consectetur consequatur rerum dolor corrupti nesciunt repellat sed odio deleniti unde dolorem consequuntur, exercitationem quae impedit vitae. Odio esse cumque ducimus sequi!';
    // 6.2 внутри .product есть .productName, после него вставляем div.desc и текстом из переменной из п. 6.1
    card.productName.insertAdjacentHTML('afterend', `<div class="desc">${textDiv}</div>`);
